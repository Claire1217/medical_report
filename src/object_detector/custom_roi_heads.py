...
class CustomRoIHeads(RoIHeads):
    ...
    def forward(
        ...
        box_feature_vectors = self.box_head(box_roi_pool_feature_maps) # 491 * 1024 * 1 * 1 
        class_logits, box_regression = self.box_predictor(box_feature_vectors) #input must be 491 * 1024 * 1 * 1  -> score (29,) ; bbox (29,4)
        detector_losses = {}
