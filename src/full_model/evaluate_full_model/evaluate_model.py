...
"""
import sys
sys.path.insert(0, '/Users/claire/Desktop/Stuff-/codes/dissertation/cxr/rgrg/src')
import os
...
from full_model.evaluate_full_model.evaluate_language_model import evaluate_language_model
from full_model.run_configurations import PRETRAIN_WITHOUT_LM_MODEL, WEIGHT_OBJECT_DETECTOR_LOSS, WEIGHT_BINARY_CLASSIFIER_REGION_SELECTION_LOSS, WEIGHT_BINARY_CLASSIFIER_REGION_ABNORMAL_LOSS, WEIGHT_LANGUAGE_MODEL_LOSS
