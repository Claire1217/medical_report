...
from evaluate_full_model.evaluate_model import evaluate_model
from report_generation_model import ReportGenerationModel
from run_configurations import (
    RUN,
    RUN_COMMENT,
    SEED,
...
def main():
    ...
    # )
    checkpoint = torch.load("/Users/claire/Desktop/Stuff-/codes/dissertation/data/checkpoints/full_model_checkpoint_val_loss_19.793_overall_steps_155252.pt")
