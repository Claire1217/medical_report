...
RUN = 38
CHECKPOINT = "/Users/claire/Desktop/Stuff-/codes/dissertation/data/checkpoints/full_model_checkpoint_val_loss_19.793_overall_steps_155252.pt"
...
def main():
    ...
    for i in range(20, 80):
        test_dataset_complete = CustomDataset("test", tokenized_test_dataset.select(range(20*i, 20 * i +20)), test_transforms, log)
        test_2_dataset_complete = CustomDataset("test", tokenized_test_2_dataset.select(range(20*i, 20*i + 20)), test_transforms, log)
